module github.com/josh5276/keyring

go 1.13

require (
	github.com/aulanov/go.dbus v0.0.0-20150729231527-25c3068a42a0
	github.com/danieljoos/wincred v1.0.2-0.20180802041825-ba0c72876178
	github.com/dvsekhvalnov/jose2go v0.0.0-20170629143815-9f050a91b1f2
	github.com/godbus/dbus v4.0.1-0.20170707174628-bd29ed602e2c+incompatible
